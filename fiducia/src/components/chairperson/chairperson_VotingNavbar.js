        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item ">
                <a class="nav-link" href="/VotingStart">START &nbsp;&nbsp;</a>
               
              </li>
              <li class="nav-item ">
                <a class="nav-link" href="/VotingSet">SET &nbsp;&nbsp;</a>
               
              </li>
              <li class="nav-item ">
                <a class="nav-link" href="/VotingTime">MANAGE TIME DURATION &nbsp;&nbsp;</a>
               
              </li>
              <li class="nav-item ">
                <a class="nav-link" href="/VotingReset">RESET &nbsp;&nbsp;</a>
